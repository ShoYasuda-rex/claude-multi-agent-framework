...
- **いずれか（または両方）存在する** → `references/edit.md` を Read で読み込み、編集モードの手順に従う
...
`references/output-formats.md` を Read で読み込み、CORE.md 出力フォーマット・ルール・アンチパターンに従って docs/CORE.md を生成する。
...
`references/output-formats.md` を Read で読み込み（未読の場合）、ARCHITECTURE.md 出力フォーマット・ルール・アンチパターンに従って docs/ARCHITECTURE.md を生成する。
...
→ `references/edit.md` を Read で読み込み、手順に従う。
